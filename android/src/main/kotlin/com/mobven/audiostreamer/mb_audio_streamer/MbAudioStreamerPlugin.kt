package com.mobven.audiostreamer.mb_audio_streamer
...
/** MBAudioStreamerPlugin */
class MBAudioStreamerPlugin : FlutterPlugin, RequestPermissionsResultListener, EventChannel.StreamHandler, ActivityAware {

    // / Constants
    private val eventChannelName = "mb_audio_streamer.eventChannel"

    // / Method channel for returning the sample rate.
    private val methodChannelName = "mb_audio_streamer.methodChannel"
    ...
    private val logTag = "MBAudioStreamerPlugin"
