...
const String EVENT_CHANNEL_NAME = 'mb_audio_streamer.eventChannel';
const String METHOD_CHANNEL_NAME = 'mb_audio_streamer.methodChannel';

/// API for streaming raw audio data.
class MBAudioStreamer {
  ...
  static MBAudioStreamer? _instance;

  /// Constructs a singleton instance of [MBAudioStreamer].
  ///
  /// [MBAudioStreamer] is designed to work as a singleton.
  // When a second instance is created, the first instance will not be able to listen to the
  // audio because it is overridden. Forcing the class to be a singleton class can prevent
  // misuse of creating a second instance from a programmer.
  factory MBAudioStreamer() => _instance ??= MBAudioStreamer._();
